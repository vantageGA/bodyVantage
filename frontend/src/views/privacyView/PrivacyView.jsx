  ...
  return (
    <>
      <fieldset className="fieldSet">
        ...
        <h2>Log Files</h2>
        <p>
          fisicalfitness.co.uk follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, fisicalfitness.co.uk uses 'cookies'. These
        ...
        <p>
          ...
          advertising partners of fisicalfitness.co.uk.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on fisicalfitness.co.uk, which
        ...
        <p>
          Note that fisicalfitness.co.uk has no access to or control over these
          cookies that are used by third-party advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          fisicalfitness.co.uk's Privacy Policy does not apply to other
        ...
        <p>
          fisicalfitness.co.uk does not knowingly collect any Personal
